!function (t, e) {
    ...
    if ("undefined" != typeof module && module.exports) {
        ...
        "function" == typeof define && define.amd ? define("bootstrap-dialog", ["jquery", "bootstrap"], function (t) {
            return e(t)
...
(this, function (t) {
    ...
    n.getModalVersion = function () {
        ...
        n.ORIGINAL_BODY_PADDING = parseInt(t("body").css("padding-right") || 0, 10),
    ...
    return o.BootstrapDialogModal = n,
        ...
        o.DEFAULT_TEXTS = {},
        o.DEFAULT_TEXTS[o.TYPE_DEFAULT] = "Information",
        o.DEFAULT_TEXTS[o.TYPE_INFO] = "Information",
        o.DEFAULT_TEXTS[o.TYPE_PRIMARY] = "Information",
        o.DEFAULT_TEXTS[o.TYPE_SUCCESS] = "Success",
        o.DEFAULT_TEXTS[o.TYPE_WARNING] = "Warning",
        o.DEFAULT_TEXTS[o.TYPE_DANGER] = "Danger",
        ...
        o.getDialog = function (t) {
            var e = null;
            return "undefined" != typeof o.dialogs[t] && (e = o.dialogs[t]),
                e
        },
        o.setDialog = function (t) {
            return o.dialogs[t.getId()] = t,
                t
        },
        ...
        o.prototype = {
            ...
            updateSize: function () {
                if (this.isRealized()) {
                    var e = this;
                    this.getModal().removeClass(o.SIZE_NORMAL).removeClass(o.SIZE_SMALL).removeClass(o.SIZE_WIDE).removeClass(o.SIZE_LARGE).removeClass(o.SIZE_FULL),
                    ...
                    this.getSize() === o.SIZE_FULL && this.getModalDialog().addClass("modal-full"),
                ...
                "undefined" != typeof e.hotkey && (this.registeredButtonHotkeys[e.hotkey] = n),
                    n.on("click", {
                        ...
                        var e = t.data.dialog,
                            n = t.data.$button,
                            o = n.data("button");
                        return o.autospin && n.toggleSpin(!0),
                            "function" == typeof o.action ? o.action.call(n, e, t) : void 0
                    }),
                    this.enhanceButton(n),
                "undefined" != typeof e.enabled && n.toggleEnable(e.enabled),
                    n
            },
                ...
                return t.dialog = this,
                    ...
                    t.toggleSpin = function (e) {
                        ...
                        return "undefined" == typeof e && (e = !(t.find(".icon-spin").length > 0)),
                            e ? (i.hide(), t.prepend(o.createButtonIcon(o.getSpinicon()).addClass("icon-spin"))) : (i.show(), t.find(".icon-spin").remove()),
                            n
                    },
                    t.spin = function () {
                        var t = this;
            ...
            handleModalEvents: function () {
                return this.getModal().on("show.bs.modal", {
                    ...
                    this.getModal().on("hidden.bs.modal", {
                        ...
                        n.isAutodestroy() && (n.setRealized(!1), delete o.dialogs[n.getId()], t(this).remove()),
                            o.moveFocus()
                    }),
        ...
        o.alert = function () {
            ...
            return e = "object" == typeof arguments[0] && arguments[0].constructor === {}
                .constructor ? t.extend(!0, n, arguments[0]) : t.extend(!0, n, {
                message: arguments[0],
                ...
                new o({
                    ...
                    buttons: [{
                        label: e.buttonLabel,
                        action: function (t) {
                            return t.setData("btnClicked", !0),
                                "function" == typeof t.getData("callback") && t.getData("callback").call(this, !0) === !1 ? !1 : t.close()
                        }
                    }]
                }).open()
        },
...
//             // console.log(xhr);
//             if (xhr.status == 404) {
//                 //     swal("Page Not Found!", "Page " + url + " is not found", "error");
//                 jQuery.growl.error({
//                     title: "Error",
...
//             }
//             else {
//                 // swal(errorThrown + ". Status: " + xhr.status, "Page " + url + " is error", "error");
//                 jQuery.growl.error({
//                     title: "Error",
//                     message: "Something went wrong-" + xhr.status
//                 });
//             }
//         }
//     });
